    ...
    public static void main(String args[])
  {
   ...
   if (Z_HP < 1)
   {
       ...
       if (answer100.equals("open"))
       {
           ...
           if (Your_HP == 50)
           {
               System.out.println("You got the highest HP possible good job");
            }
           
           
           
           System.out.println("Type 0 to exit and any other number to play again");
